 ...
 *  CREATE TABLE-ing the whole file. This is vura-local's own copy, matching
 *  how fileFormats.ts is already independently duplicated between
 *  vura-s3 and vura-local rather than shared. */
