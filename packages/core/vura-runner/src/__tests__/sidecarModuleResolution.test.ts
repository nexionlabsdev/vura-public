...
describe('Sidecar Module Resolution (@vura/io, vura, vura_io, vura_bridge)', () => {
    ...
    it('resolves @vura-data-os/vura-io, @vura/io, vura-io, vura_io, vura_bridge, and vura in Node.js sidecar', async () => {
        ...
        const testScript = `
            const io0 = require('@vura-data-os/vura-io');
            ...
            if (!io0 || !io0.data) throw new Error('@vura-data-os/vura-io missing data');
