...
module.exports = {
  ...
  // Also ignore e2eNotebook.test.ts which requires VS Code Electron via `npm run test:e2e`.
  testPathIgnorePatterns: ['/node_modules/', '<rootDir>/out/', 'e2eNotebook\\.test\\.ts$'],
};
