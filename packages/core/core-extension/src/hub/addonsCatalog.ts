...
export const ADDON_CATALOG: AddonCatalogEntry[] = [
    { extensionId: 'nexion-labs.vura-dataverse', displayName: 'Microsoft Dataverse', kind: 'dataverse', description: 'Sync tables to and from a Microsoft Dataverse environment.', tags: ['Official', 'Driver'] },
    { extensionId: 'nexion-labs.vura-sharepoint', displayName: 'SharePoint', kind: 'sharepoint', description: 'Sync SharePoint Lists, import/export files from a document library.', tags: ['Official', 'Driver'] },
    { extensionId: 'nexion-labs.vura-onedrive', displayName: 'OneDrive', kind: 'onedrive', description: "Import/export files from a specific user's OneDrive.", tags: ['Official', 'Driver'] },
    { extensionId: 'nexion-labs.vura-googledrive', displayName: 'Google Drive', kind: 'googledrive', description: 'Import/export files from Google Drive.', tags: ['Official', 'Driver'] },
    { extensionId: 'nexion-labs.vura-s3', displayName: 'Amazon S3', kind: 's3', description: 'Import/export objects from an Amazon S3 bucket.', tags: ['Official', 'Driver'] },
    { extensionId: 'nexion-labs.vura-local', displayName: 'Local / Mapped Folder', kind: 'local', description: 'Import/export files from a local folder or mapped/mounted drive.', tags: ['Official', 'Driver'] }
];
