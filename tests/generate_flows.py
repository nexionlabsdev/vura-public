...
4. JavaScript cell data enrichment via @vura/io batch streaming
...
cells:
  - kind: 1
    ...
    value: >-
      ...
      them with Python (pandas) and JavaScript (@vura/io streaming), and returns
  ...
  - kind: 2
    language: javascript
    value: >-
      // Step 3: JS enrichment via @vura/io streaming in chunks
