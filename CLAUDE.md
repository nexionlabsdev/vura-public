...
- **`packages/core-sdk`** — Shared Add-on contract interfaces (`IVuraProvider`, `ProviderRegistry`, `IVuraEnvironment`, `FlownbCell`, `ICellLogger`).
- **`packages/vura-runner`** — The CLI notebook runner and engine host.
